...
describe('transactions', function () {
	...
	describe('getTransactions', function () {
		...
		beforeEach(function () {
			var account1PublicKey = node.tops.crypto.getKeys(node.randomPassword()).publicKey;
			var account2PublicKey = node.tops.crypto.getKeys(node.randomPassword()).publicKey;
			...
			testBody = {
				...
				senderIds: [node.tops.crypto.getAddress(account1PublicKey), node.tops.crypto.getAddress(account2PublicKey)],
				recipientIds: [node.tops.crypto.getAddress(account1PublicKey), node.tops.crypto.getAddress(account2PublicKey)],
				fromHeight: 1,
				toHeight: 2,
				fromTimestamp: 0,
				toTimestamp: 2,
