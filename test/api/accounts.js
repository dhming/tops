...
describe('GET /api/accounts/getBalance?address=', function () {
	...
	it('using invalid address should fail', function (done) {
		getBalance('thisIsNOTATopsAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error').to.eql('Object didn\'t pass validation for format address: thisIsNOTATopskAddress');
			done();
		});
	});
...
describe('GET /api/accounts/getPublicKey?address=', function () {
	...
	it('using invalid address should fail', function (done) {
		getPublicKey('thisIsNOTATopsAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error').to.contain('Object didn\'t pass validation for format address: thisIsNOTATopsAddress');
			done();
		});
	});
...
describe('GET /accounts', function () {
	...
	it('using invalid address should fail', function (done) {
		getAccounts('address=' + 'thisIsNOTATopsAddress', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error');
			node.expect(res.body.error).to.contain('Object didn\'t pass validation for format address: thisIsNOTATopsAddress');
			done();
		});
	});
	...
	it('using invalid publicKey should fail', function (done) {
		getAccounts('publicKey=' + 'thisIsNOTATopsAccountPublicKey', function (err, res) {
			node.expect(res.body).to.have.property('success').to.be.not.ok;
			node.expect(res.body).to.have.property('error');
			node.expect(res.body.error).to.contain('Object didn\'t pass validation for format publicKey: thisIsNOTATopsAccountPublicKey');
			done();
		});
	});
